// app/admin/church/departments/new/page.tsx
'use client'
                ...
                <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/50 dark:border-gray-700/50 p-8">
                    <div className="mb-6">
                        ...
                        <p className="text-gray-600 dark:text-gray-300 mt-2">
                            Add a new department or ministry to organize your church activities and teams
                        </p>
                    </div>

                    <ChurchDepartmentForm onSaved={() => router.push('/admin/church/departments')} />
                </div>
            </div>
        </div>
    )
